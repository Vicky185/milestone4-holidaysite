    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departs', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('cover', models.CharField(blank=True, choices=[('B&B', 'B&B'), ('Half Board', 'Half Board'), ('Full Board', 'Full Board')], max_length=10, null=True)),
