...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        subject = render_to_string('../templates/confirmation_emails/confirmation_email_subject.txt', {'order': order})
        body = render_to_string('../templates/confirmation_emails/confirmation_email_body.txt', {'order': order, 'contact_email': settings.DEFAULT_FROM_EMAIL})
